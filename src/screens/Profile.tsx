...
import { User, Car, MapPin, CreditCard, Shield, HelpCircle, LogOut, ChevronRight, Settings } from 'lucide-react';
    ...
    <div className="flex flex-col min-h-screen bg-slate-50 pb-20">
      <div className="bg-slate-900 px-6 pt-12 pb-10 text-white rounded-b-[2rem] relative z-10 shadow-sm">
        ...
        <div className="flex items-center">
          ...
          <div>
            <h2 className="font-bold text-xl mb-0.5">Ashwaq Ahmed</h2>
            <p className="text-slate-400 text-sm font-medium">ashwaq.btech@gmail.com</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 relative z-0 space-y-4">
        ...
        <button className="w-full bg-white rounded-3xl p-4 shadow-sm border border-slate-100 flex items-center justify-center text-red-500 font-bold mt-8 active:scale-[0.98] transition-all hover:border-red-100 hover:bg-red-50/30">
...
const ProfileItem = ({ icon, label, onClick, border = true }: { icon: React.ReactNode, label: string, onClick?: () => void, border?: boolean }) => (
  ...
  >
    <div className="flex items-center">
      <div className="w-10 h-10 rounded-2xl bg-indigo-50 flex items-center justify-center text-indigo-600 mr-4">
